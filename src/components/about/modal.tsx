    ...
    <>
      ...
      <dialog id="about_modal" className="modal">
        <div className="modal-box">
          ...
          <p className="py-2">I'm IJsbrand van de Lindt. I live in the Netherlands and my hobbies are programming and gaming. I started with learning HTML and CSS in 2023, but when I was younger I was already messing around in Scratch. I later also build games on the platform Roblox. My main motivation for building products is seeing people enjoy using them.</p>

          <h4 className="text-lg md:text-2xl">Music</h4>
          <p className="py-2">I also listen to a wide variety of music, think of bands like Pink Floyd, Metallica, Queen, Radiohead, Guns N' Roses, King Crimson, Weather Report, ELO and more. One of my favorite songs is November Rain by Guns N' Roses.</p>
